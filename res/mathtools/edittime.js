...
{
	return {
		"name":			"MathTools",			// as appears in 'insert object' dialog, can be changed as long as "id" stays the same
		"id":			"MathTools",				// this is used to identify this plugin and is saved to the project; never change it
		"version":		"1.0",					// (float in x.y format) Plugin version - C2 shows compatibility warnings based on this
		"description":	"Additional mathematics tools",
		"author":		"Matthew Bowden",
		"help url":		"bowdenm.cs.spu.edu/curl",
		"category":		"Math",				// Prefer to re-use existing categories, but you can set anything here
...
AddExpression(0, ef_return_number, "To Polar & Get 'r'", "Conversions", "ToPolarGetR", "Convert X,Y coordinates to polar coordinates, return 'r'");
